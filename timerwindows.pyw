...
if __name__=='__main__':
    ...
    root.geometry('{}x{}'.format(400, 295))
    ...
    buttons = [ ('Start', start,buttonFont, 'green', 'yellow','brown'), ('Stop', pause,buttonFont, 'red', 'yellow', 'brown'),
            ('Reset', reset, buttonFont, 'blue', 'yellow', 'brown')]
